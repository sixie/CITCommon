...
{
public:
  CMCTemplateConvGaussian(RooRealVar &m, TH1D* hist, const Bool_t pass, RooRealVar *mean0 = 0, RooRealVar *sigma0=0);
...
{
public:
  CMCDatasetConvGaussian(RooRealVar &m, TTree* tree, const Bool_t pass,  RooRealVar *mean0=0, RooRealVar *sigma0=0);
...
//--------------------------------------------------------------------------------------------------
CMCDatasetConvGaussian::CMCDatasetConvGaussian(RooRealVar &m, TTree* tree, const Bool_t pass, 
                                               RooRealVar *mean0, RooRealVar *sigma0)
{  
  char name[10];
  if(pass) sprintf(name,"%s","Pass");
